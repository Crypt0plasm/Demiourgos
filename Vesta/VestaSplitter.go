...
var (
	...
	VaultBtcUser000 = VestaDexVault{p.NFS("103761.157413112828558915"), p.NFS("0"), p.NFS("0"), p.NFS("0")}
	...
	VaultBtcUser029 = VestaDexVault{p.NFS("137013.79615177735005381"), p.NFS("0"), p.NFS("0"), p.NFS("0")}
