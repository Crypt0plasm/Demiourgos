...
var (
	...
	VaultBtcUser000 = VestaDexVault{p.NFS("130510.114892803240307085"), p.NFS("0"), p.NFS("0"), p.NFS("0")}
	...
	VaultBtcUser029 = VestaDexVault{p.NFS("137144.011610214850041208"), p.NFS("0"), p.NFS("0"), p.NFS("0")}
