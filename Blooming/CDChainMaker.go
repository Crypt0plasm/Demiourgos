...
//
// [A]01         CreateSnakeEyeChain		SnakeEye Snapshooter Function; Creates a Chain of SnakeEye Values.
// [A]02         CreateRudisChain		Rudis Snapshooter Function; Creates a Chain of Rudis Values.
// [A]03         CreateGwenChain			Gwen Snapshooter Function; Creates a Chain of Gwen Values.
// [A]04         CreateClutterChain            	Clutter Snapshooter Function; Creates a Chain of Clutter Values.
// [A]05         CreateBangaiChain            	Bangai Snapshooter Function; Creates a Chain of Bangai Values.
// [A]06         CreateBinosChain            	Binos Snapshooter Function; Creates a Chain of Binos Values.
// [A]07         CreateRubiaChain            	Rubia Snapshooter Function; Creates a Chain of Rubia Values.
// [A]08         CreateOcultusChain            	Ocultus Snapshooter Function; Creates a Chain of Ocultus Values.
// [A]09         CreateOretaChain            	Oreta Snapshooter Function; Creates a Chain of Oreta Values.
// [A]10         CreateBinarChain            	Binar Snapshooter Function; Creates a Chain of Binar Values.
//
...
// ======================================================================================================================
//
// [A]01         CreateSnakeEyeChain
//
//	SnakeEye Snapshooter Function; Creates a Chain of SnakeEye Values.
func CreateSnakeEyeChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD01SnakeEye)
...
// ======================================================================================================================
//
// [A]02         CreateRudisChain
//
//	Rudis Snapshooter Function; Creates a Chain of Rudis Values.
func CreateRudisChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD02Rudis)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
...
// ======================================================================================================================
//
// [A]03         CreateGwenChain
//
//	Gwen Snapshooter Function; Creates a Chain of Gwen Values.
func CreateGwenChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD03Gwen)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
...
// ======================================================================================================================
//
// [A]04         CreateClutterChain
//
//	Gwen Snapshooter Function; Creates a Chain of Clutter Values.
func CreateClutterChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD04Clutter)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
}
...
// ======================================================================================================================
//
// [A]05         CreateBangaiChain
//
//	Bangai Snapshooter Function; Creates a Chain of Bangai Values.
func CreateBangaiChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD05Bangai)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
}
...
// ======================================================================================================================
//
// [A]06         CreateBinosChain
//
//	Binos Snapshooter Function; Creates a Chain of Binos Values.
func CreateBinosChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD06Binos)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
...
// ======================================================================================================================
//
// [A]07         CreateRubiaChain
//
//	Rubia Snapshooter Function; Creates a Chain of Rubia Values.
func CreateRubiaChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD07Rubia)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
...
// ======================================================================================================================
//
// [A]08         CreateOcultusChain
//
//	Ocultus Snapshooter Function; Creates a Chain of Ocultus Values.
func CreateOcultusChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD08Ocultus)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
}
...
// ======================================================================================================================
//
// [A]09         CreateOretaChain
//
//	Oreta Snapshooter Function; Creates a Chain of Oreta Values.
func CreateOretaChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD09Oreta)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
...
// ======================================================================================================================
//
// [A]10         CreateBinarChain
//
//	Binar Snapshooter Function; Creates a Chain of Binar Values.
func CreateBinarChain() []BalanceSFT {
  var OutputChain []BalanceSFT
  SS := OnPage(CD10Binar)
  _ = json.Unmarshal([]byte(SS), &OutputChain)
  return OutputChain
...
func CreateCodingDivisionChain() (DecaChain, int, *p.Decimal) {
  ...
  SnakeEyeChain := CreateSnakeEyeChain()
  ...
  ClutterChain := CreateClutterChain()
  ...
  OcultusChain := CreateOcultusChain()
